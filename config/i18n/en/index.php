...
return array(
    ...
    "admin.setting.passwordRuleStrongDesc" => "The length is greater than 6; must contain numbers; English letters",
    "admin.setting.passwordRuleStrongMoreDesc" => "Length greater than 8; must contain numbers; uppercase English; lowercase English",
...
<li> IP range: ip matches within the range; for example: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.setting.clearUserRecycle" => "Empty all user  trash",
...
<li> Update: After downloading, upload and unzip to the corresponding plug-in name folder;</li>",
    ...
    "admin.storage.errNoCnt"         => "%s physical files do not exist",
    ...
    "admin.storage.tryOrRmNow"       => "You can cancel and try again, or choose to uninstall directly.",
    ...
    "admin.backup.optionLocation"    => "If you need to back up files, please create a new storage specifically for backup",
 ...
 post_max_size, need to restart)",
    ...
    "common.copyright.desc"          => "NOKOV Box",
    "common.copyright.contact"       => "support@nokov.com",
    "common.copyright.homepage"      => "Copyright © <a href=\"https://nokov.com/\" target=\"_blank\">nokov.com</a>.",
    "common.copyright.name"          => "NOKOV Box",
    "common.copyright.nameTitle"     => "NOKOV Box",
    "common.copyright.nameDesc"      => "NOKOV Box • Explorer",
    "common.copyright.powerBy"       => "Powered by NOKOV Box",
    "common.copyright.metaKeywords"  => "NOKOV Box, KodExplorer, kod, Nokov Box, webos, webIDE, php filemanage, filemanage, Kedao Cloud, Mango Cloud, Document Management System, Enterprise Cloud Disk, Explorer, Online Documents, Online Office, Online Office, Online CAD Preview, Online editor, online editor",
    "common.copyright.metaName"      => "NOKOV Box",
    ...
    "explorer.recycleClear"          => "Empty trash",
 ...
 Support pinyin, fuzzy matching of the first letter",
    ...
    "explorer.share.pageDoc"         => "Document Knowledge Mode",
    ...
    "explorer.secret.setUserDesc"    => "Specify the user who can set the confidentiality level (must be the owner in the corresponding department at the same time)",
    ...
    "explorer.secret.tips1"          => "Only for the content under the departmental network disk, the above-mentioned specified user can set the confidentiality level (and must be the folder owner at the same time)",
