...
<li>IP区间段: ip在区间内则匹配;例如:192.168.1.1-192.168.200.255</li>",
    ...
    "admin.storage.oosKeyDesc"       => "Access Key ID，请在【控制台-您的安全凭证】中创建",
...
post_max_size,需要重启)",
    ...
    "common.copyright.nameDesc"      => "NOKOV Box•资源管理器",
    "common.copyright.powerBy"       => "Powered by NOKOV Box",
    "common.copyright.metaKeywords"  => "NOKOV Box,KodExplorer,kod,kodCloud,webos,webIDE,php filemanage,filemanage,NOKOV Box,芒果云,文档管理系统,企业云盘,资源管理器,,在线文档,在线Office,在线办公,在线CAD预览,在线编辑,在线编辑器",
